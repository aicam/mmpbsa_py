...
input_file.addNamelist('gb', 'gb',
  ...
  ['probe', float, 1.4, 'Solvent probe radius for surface area calc.'],
                           # GBNSR6 specific parameters probe, saltcon
  ['b', float, 0.028, 'Specifies the value of uniform offset to the (inverse) effective radii'],
  ...
  ['Rs', float, 0.52, 'Sets the value of the dielectric boundary shift compared to the molecular surface'],
  ['space', float, 0.5, 'Sets the grid spacing that determines the resolution of the solute molecular surface'],
  ['arcres', float, 0.2, 'Sets the arc resolution used for numerical integration over molecular surface'],
  ['rbornstat', int, 0, '0 values of the inverse effective Born radii are not printed'],
  ['dgij', int, 0, 'This flag is used for printing pairwise electrostatic energies'],
  ['radiopt', int, 0, 'Specifies the set of intrinsic atomic radii to be used with the chagb option'],
  ['chagb', int, 0, '0 Do not use CHAGB'],
  ['ROH', float, 0.586, 'Sets the value of R_oh'],

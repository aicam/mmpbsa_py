...
def create_inputs(INPUT, prmtop_system, pre):
   ...
   # GBNSR6
   if INPUT['gbnsr6run']:
      gbnsr6_mdin = GBNSR6Input(INPUT)
      gbnsr6_mdin.write_input(pre + 'gbnsr6.mdin')
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
# GBNSR6
class GBNSR6Input(NabInput):
   """ The GB input file for the gbnsr6 program """
   input_items = {'b': 0.028,
                  'alpb': 1,
                  'epsin': 1.0,
                  'epsout': 78.5,

...
# GBNSR6
class GBNSR6out(GBout):
   def __init__(self, basename, INPUT, num_files=1, chamber=False):
      GBout.__init__(self, basename, INPUT, num_files, chamber)
      self.structure = 'complex' if basename.__contains__('complex') else \
         'receptor' if basename.__contains__('receptor') else \
         'ligand'
      EGB_GBNSR6 = []
      ...
      EGB_GBNSR6_vector = EnergyVector(EGB_GBNSR6)
      self.data['EGB'] = EGB_GBNSR6_vector
